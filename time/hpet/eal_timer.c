...
rte_eal_hpet_init(int make_default)
{
    ...
    printf("HPET frequency is ~%"PRIu64" kHz\n",
    ...
    ret = pthread_create(&msb_inc_thread_id,  NULL,
            hpet_msb_inc, NULL);
    if (ret != 0) {
        printf("ERROR: Cannot create HPET timer thread!\n");
        return -1;
    }
